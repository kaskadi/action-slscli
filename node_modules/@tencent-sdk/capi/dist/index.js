(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('crypto'), require('moment'), require('chalk'), require('request-promise-native'), require('object-assign'), require('querystring')) :
    typeof define === 'function' && define.amd ? define(['exports', 'crypto', 'moment', 'chalk', 'request-promise-native', 'object-assign', 'querystring'], factory) :
    (factory((global.capi = {}),global.crypto,global.moment,global.chalk,global['request-promise-native'],global['object-assign'],global.querystring));
}(this, (function (exports,crypto,moment,chalk,rp,assign,qs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function logger(topic, content) {
        console.log(chalk.black.bgYellow('[DEBUG]') + " " + chalk.green(topic + ":") + " " + content + " ");
    }
