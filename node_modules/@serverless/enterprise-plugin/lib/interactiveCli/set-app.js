  ...
  setOrgAndApp: function () {
    var _setOrgAndApp = _asyncToGenerator(function* (serverless, {
      ...
      if (serverless.service.isDashboardMonitoringOverridenByCli && serverless.service.isDashboardAppPreconfigured) {
        const _ref10 = yield inquirer.prompt({
          ...
          name: 'shouldOverrideDashboardConfig'
              ...
              shouldOverrideDashboardConfig = _ref10.shouldOverrideDashboardConfig;
...
module.exports = {
  check(serverless) {
    return _asyncToGenerator(function* () {
      ...
      const _ref11 = yield getMetadata(),
            supportedRegions = _ref11.supportedRegions,
            supportedRuntimes = _ref11.supportedRuntimes;
