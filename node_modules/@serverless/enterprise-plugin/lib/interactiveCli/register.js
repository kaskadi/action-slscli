...
const steps = {
  registerOrLogin: function () {
    var _registerOrLogin = _asyncToGenerator(function* (serverless) {
      ...
      const _ref7 = yield signUp(inquirer),
            ownerUserName = _ref7.ownerUserName,
            orgName = _ref7.orgName,
            ownerAccessKey = _ref7.ownerAccessKey,
            ownerAuth0Id = _ref7.ownerAuth0Id;
...
module.exports = {
  check(serverless) {
    return _asyncToGenerator(function* () {
      ...
      const _ref9 = yield getMetadata(),
            supportedRegions = _ref9.supportedRegions,
            supportedRuntimes = _ref9.supportedRuntimes;
